...
const projects: Project[] = [
  {
    ...
    description: 'A sample uniform design concept for the Kamalayan organization, focusing on a modern and professional look.',
    tools: ['Photoshop'],
  },
  {
    id: 2,
    title: 'Kamalayan Uniform Sample',
    category: 'Sample 2',
    imageUrl: '/assets/pro2.jpg',
    description: 'A second alternative uniform design for Kamalayan, exploring a different color palette and logo placement.',
    tools: ['Photoshop'],
  },
  {
    id: 3,
    title: 'Kamalayan Uniform Sample',
    category: 'Sample 3',
    imageUrl: '/assets/pro3.png',
    description: 'A third uniform concept that presents a more minimalist and clean aesthetic for the Kamalayan brand.',
    tools: ['Photoshop'],
  },
  {
    id: 4,
    ...
    category: 'Tarpaulin',
    imageUrl: '/assets/pro4.jpg',
    description: 'A large-format tarpaulin designed for a major Kamalayan event, ensuring high visibility and brand impact.',
    tools: ['Photoshop'],
  },
  {
    id: 5,
    title: 'Event Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro5.png',
    description: 'A general-purpose tarpaulin design suitable for a variety of corporate and community events.',
    tools: ['Photoshop'],
  },
  {
    id: 6,
    title: 'Promotional Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro6.png',
    description: 'A visually striking tarpaulin created for a promotional campaign, designed to attract attention.',
    tools: ['Photoshop'],
  },
  {
    id: 7,
    title: 'Conference Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro7.png',
    description: 'A professional and informative tarpaulin layout for a corporate conference or seminar.',
    tools: ['Photoshop'],
  },
  {
    id: 8,
    title: 'Festival Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro8.png',
    description: 'A vibrant and energetic tarpaulin design for a local festival, capturing the spirit of the event.',
    tools: ['Photoshop'],
  },
  {
    id: 9,
    title: 'Product Launch Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro9.png',
    description: 'A tarpaulin designed to create excitement and buzz for a new product launch event.',
    tools: ['Photoshop'],
  },
  {
    id: 10,
    title: 'Community Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro10.png',
    description: 'An engaging tarpaulin design for a community outreach program or local gathering.',
    tools: ['Photoshop'],
  },
   {
    id: 11,
    title: 'Celebration Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro11.png',
    description: 'A colorful and festive tarpaulin created for a special celebration or anniversary.',
    tools: ['Photoshop'],
  },
   {
    id: 12,
    title: 'Corporate Event Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro12.png',
    description: 'A sleek and modern tarpaulin for a corporate function, emphasizing brand professionalism.',
    tools: ['Photoshop'],
  },
   {
    id: 13,
    title: 'Workshop Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro13.png',
    description: 'An informational and clean tarpaulin layout for an educational workshop or training session.',
    tools: ['Photoshop'],
  },
   {
    id: 14,
    ...
    category: 'Tarpaulin',
    imageUrl: '/assets/pro14.png',
    description: 'A bold tarpaulin designed to announce the grand opening of a new business or location.',
    tools: ['Photoshop'],
  },
   {
    id: 15,
    title: 'Artistic Tarpaulin Concept',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro15.png',
    description: 'An artistic and conceptual tarpaulin design, exploring creative visual themes.',
    tools: ['Photoshop'],
  },
   {
    id: 16,
    title: 'Sports Event Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro16.png',
    description: 'A dynamic and high-energy tarpaulin for a local sports tournament or competition.',
    tools: ['Photoshop'],
  },
   {
    id: 17,
    title: 'Minimalist Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro17.png',
    description: 'A minimalist tarpaulin design that uses negative space and clean typography for a modern feel.',
    tools: ['Photoshop'],
  },
  {
    id: 18,
    title: 'Impactful Tarpaulin Design',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro18.png',
    description: 'A bold and impactful tarpaulin using strong colors and graphics to make a statement.',
    tools: ['Photoshop'],
  },
  {
    id: 19,
    title: 'Charity Event Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro19.png',
    description: 'A tarpaulin designed to raise awareness and support for a charity event or fundraiser.',
    tools: ['Photoshop'],
  },
  {
    id: 20,
    title: 'School Function Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro20.png',
    description: 'A fun and welcoming tarpaulin design for a school event, such as a fair or open day.',
    tools: ['Photoshop'],
  },
  {
    id: 21,
    title: 'Creative Layout Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro21.png',
    description: 'Another creative take on tarpaulin design, experimenting with unique layouts and compositions.',
    tools: ['Photoshop'],
  },
  {
    id: 22,
    title: 'Abstract Tarpaulin',
    category: 'Tarpaulin',
    imageUrl: '/assets/pro22.png',
    description: 'A final tarpaulin design in the series, featuring an abstract and artistic approach.',
    tools: ['Photoshop'],
  },
];
